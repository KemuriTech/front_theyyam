    ...
    <section class="text-black body-font overflow-hidden">
        <div class="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center ">
            <div class="lg:flex-grow flex flex-col md:items-start md:text-left sm:mb-5 mb-16 md:mb-0 items-center text-center">
                <h1 class="title-font tracking-wide text-5xl md:text-7xl mb-4 font-bold ">Lorem ipsum dolor sit amet.
                </h1>
                <p class="mb-8 text-lg leading-8 text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus, sit ut fermentum posuere platea. Cras turpis adipiscing varius id sed leo morbi. Morbi amet, lectus pretium et vitae duis lectus in lorem. </p>
                <div class="flex justify-center">
                    <NuxtLink class="inline-flex text-white bg-blue-700 py-2 px-4 focus:outline-none hover:bg-opacity-80 rounded-md	text-sm" to="/events">View Events</NuxtLink>
                </div>
            </div>
    ...
    <div class="relative bg-gray-900">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
            <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                <h2 class="text-sm font-semibold text-indigo-400 tracking-wide">What is Theyyam?</h2>
    ...
    <UpcomingEvents/>
        <div class="relative">
          <div class="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]" aria-hidden="true">
            <div class="bg-clip-right relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[45deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(100%-20rem)] sm:w-[72.1875rem]" />
          </div>
        </div>
        <div class="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
            <div>
                <h2 class="text-base font-semibold tracking-wider text-indigo-600">Why to visit Theyyam</h2>
                <p class="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Lorem ipsum dolor.</p>
            ...
            <div class="mt-10 pb-20">
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div v-for="feature in features" :key="feature.name" class="relative">
                        <dt>
                            <div class="absolute flex items-top justify-center h-12 w-12 rounded-md text-indigo-700 mt-1">
                                <component :is="feature.icon" class="h-6 w-6 " aria-hidden="true" />
                            </div>
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900 text-left">{{ feature.name }}</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500 text-left">
                            {{ feature.description }}
                        </dd>
                    </div>
                </dl>
    ...
    <div class="relative bg-gray-900">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
            <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-2 xl:pb-24 xl:pr-10">
                <h2 class="text-sm font-semibold text-indigo-400 tracking-wide">Our Events</h2>
                <p class="mt-3 text-3xl font-extrabold text-white">Lorem ipsum dolor sit amet, consectetur.</p>
                <p class="mt-5 text-lg text-gray-300">Rhoncus sagittis risus arcu erat lectus bibendum. Ut in adipiscing quis in viverra tristique sem. Ornare feugiat viverra eleifend fusce orci in quis amet. Sit in et vitae tortor, massa. Dapibus laoreet amet lacus nibh integer quis. Eu vulputate diam sit tellus quis at.</p>
                <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                    <div class="inline-flex rounded-md shadow">
                        <NuxtLink class="inline-flex text-white bg-blue-700 py-2 px-4 focus:outline-none hover:bg-opacity-80 rounded-md	text-sm" to="/events">Go To Events</NuxtLink>
                    </div>
                </div>
            </div>
        </div>
