...
const ContactInfo = {
    ...
    <div v-if="contact1"><a :href="getTel(contact1)">{{contact1}}</a></div>
    <div v-if="contact2"><a :href="getTel(contact2)">{{contact2}}</a></div>
    <div v-if="contact3"><a :href="getTel(contact3)">{{contact3}}</a></div>
    </div>`
}
const GetMainMedia = {
    setup() {
